...
insert into orders(id, type, size, comment, user_id)
values (3, 'Prowansalska', 'medium', '', 1),
       (4, 'Margharita', 'small', 'z pieczarkami', 1),
       (5, 'Wegeteriańska', 'large', '', 1),
       (6, 'Truflowa', 'medium', 'Nie kroić', 2);